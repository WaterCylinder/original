 ...
 * 该库具有以下特点：
 * 1. 提供多种容器实现，包括 vector、chain、array 等，支持迭代器操作。
 * 2. 模板化设计，支持高性能泛型编程。
 * 3. 提供与标准库类似的接口，便于用户快速上手。
 * 4. 支持单元测试，确保代码的正确性和鲁棒性。
 *
 ...
 * 1.  Provide multiple container implementations, including vector, chain, array etc., supporting iterator operations.
 * 2.  Template based design, supporting high-performance generic programming.
 * 3.  Provide interfaces similar to standard libraries for users to quickly get started.
 * 4.  Support unit testing to ensure the correctness and robustness of the code.
 *
 * @author FrozenLemonTee
